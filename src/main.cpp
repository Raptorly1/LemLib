...
// drive motors
pros::Motor lF(-8,
               pros::E_MOTOR_GEARSET_06); // left front motor. port 8, reversed
pros::Motor
    lM(-20, pros::E_MOTOR_GEARSET_06); // left middle motor. port 20, reversed
...
pros::Motor rB(-13,
               pros::E_MOTOR_GEARSET_06); // right back motor. port 13, reversed
